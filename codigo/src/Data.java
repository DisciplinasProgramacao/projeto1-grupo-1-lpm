public class Data {
	...
	/**
	 * Contrutor da classe Data, recebe como parâmetro os elementos da data validando as informações passadas por parâmetro. Ao receber data inválida, retorna 0
	...
	/**
	 * Contrutor da classe Data, recebe como parâmetro um inteiro que representa o dia incrementado a partir do dia 01/01/0001. Exemplo, o dia 24/08/2022 seria 738391.
	...
	/**
	 * Método para retornar dia da semana em que a data passada como parâmetro ocorre
	...
	/**
	 * Método para verificar a quantidade de dias no mês, validando inclusive se o ano é bissexto
	...
	public static boolean ehValorValido(int dia, int mes, int ano) {
		...
		if (dia > 0 && mes > 0 && ano > 0) {
			if (dia <= diasMes(mes, ano) && mes <= 12 && ano < 10000) {
				...
				if (ano == 2038) {
					//			System.out.println(
					//					"O ano " + ano + " n�o � contemplado na avalia��o. Problema Y2K38 - Gangnam Style. :-) ");
					Agenda.excessaw=Agenda.excessaw+"O ano " + ano + " n�o � contemplado na avalia��o. Problema Y2K38 - Gangnam Style. :-) \n";
				}
				if (ano > 10000) {
